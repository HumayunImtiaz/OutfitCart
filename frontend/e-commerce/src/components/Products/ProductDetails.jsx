...
const selectedProduct = {
    ...
    price: 120,
    OriginalPrice: 150,
    description: "This is the Stylish Jacket perfect for any accassion",
    brand: "FasionBran",
    material: "Lather",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Red", "Black"],
...
function ProductDetails() {
    ...
    const handleQuantity=((action)=>{
        if(action==="minus" && quantity>1)  setQuantiity((prev)=> prev-1)
        if(action==="plus")  setQuantiity((prev)=> prev+1)
    })
          ...
          <div className="hidden md:flex flex-col space-y-4 mr-6 ">
            {selectedProduct.images.map((image, index) => (
              <img
                ...
                ${mainImage === image.url ? "border-black" : "border-gray-500"}`}
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-4 mt-2">
                ...
                className="px-2 py-1 bg-gray-200 rounded text-leg">
                  -
                </button>
